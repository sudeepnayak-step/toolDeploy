...
$colarr = array();
$chartsql = "select * from s_chartsetting where s_c_tablename='Test Execution'  and s_c_activestatus = 'Active' and accountId = ? order by s_c_id asc "; // get all chart w.r.t. project activity phase

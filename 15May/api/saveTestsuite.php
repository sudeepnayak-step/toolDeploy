...
if(!empty($id) && $id !="0") {
	...
	$stmt = mysqli_prepare($conn, $sql);
	mysqli_stmt_bind_param($stmt, "iiiisssiisssssssss", $projectId, $releaseId, $activityId, $testsuiteNum, $testsuiteIdstr, $testsuitename, $testsuitedesc, $enteredby, $accountId, $assignto, $type, $machinId, $command, $schedularevery, $schedulartype, $schedularstart,$artifactschk, $schedularend);

...
"  SUM(CASE WHEN s_f_testresult = 'In Progress' THEN 1 ELSE 0 END) AS total_inprogress ".
"FROM ( ".
...
"      WHERE s_f_testresult IS NOT NULL AND s_f_testresult != '' AND accountId = ?  ".
"      GROUP BY testcaseId ".
